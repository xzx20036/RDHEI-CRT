...
for row_block = 1:num_blocks_3x3_rows
    ...
    for col_block = 1:num_blocks_3x3_cols
        ...
        binary_str=dec2bin(t(i),9);
        a1=binary_str(1:2);
        [dec1, dec2, dec3] = num_to_3byte_dec(CRT(current_block_coy(1,1),current_block_coy(1,3), bin2dec(binary_str(3:9))));
        current_block_coy(1,1)=dec1;
        current_block_coy(1,2)=dec2;
        current_block_coy(1,3)=dec3;
        
        binary_str=dec2bin(t(i+1),9);
        a2=binary_str(1:2);
        [dec1, dec2, dec3] = num_to_3byte_dec(CRT(current_block_coy(1,3),current_block_coy(3,3), bin2dec(binary_str(3:9))));
        current_block_coy(1,3)=dec1;
        current_block_coy(2,3)=dec2;
        current_block_coy(3,3)=dec3;

        binary_str=dec2bin(t(i+2),9);
        a3=binary_str(1:2);
        [dec1, dec2, dec3] = num_to_3byte_dec(CRT(current_block_coy(3,3),current_block_coy(3,1), bin2dec(binary_str(3:9))));
        current_block_coy(3,3)=dec1;
        current_block_coy(3,2)=dec2;
        current_block_coy(3,1)=dec3;
        
        binary_str=dec2bin(t(i+3),9);
        a4=binary_str(1:2);
        [dec1, dec2, dec3] = num_to_3byte_dec(CRT(current_block_coy(3,1),current_block_coy(1,1), bin2dec(binary_str(3:9))));
